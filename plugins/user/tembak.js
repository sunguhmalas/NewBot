...
let example = `*Opsi Gender*:
1. male (Laki-laki)
2. female (Perempuan)

_(Contoh, ketik: *${m.prefix}gender male* untuk memilih opsi Laki-laki)._`
if (m.quoted || m.text) {
...
if (froms === m.bot) return m.reply(`Tidak bisa berpacaran dengan bot!`)
