...
let indonesian = `乂  *PERATURAN ${global.botName.toUpperCase()}*
...
let english = `乂  *RULES ${global.botName.toUpperCase()}*
...
let caption = m.sender.startsWith('62') ? indonesian : english;
